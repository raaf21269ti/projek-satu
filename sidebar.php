...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">STT Terpadu Nurul-Fikri</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Raafi Alfarizi</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="praktikum_1.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="form_belanja.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tugas Praktikum 2.1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="form_nilai.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tugas Praktikum 2.2</p>
                </a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="Daftar_mahasiswa.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tugas Praktikum 4.1</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Data_persegipanjang.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Tugas Praktikum 4.2</p>
                </a>
              </li>
              <li class="nav-item">
